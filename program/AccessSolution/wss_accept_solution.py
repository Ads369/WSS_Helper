...
spec = importlib.util.spec_from_file_location(
    'wss_webservice_controller',
    'services/wss_webservices_controller_zeep.py')
...
path_documents_list = os.getcwd() + '/program/AccessSolution/accept_solution_documents_list.txt'
...
for line in open(path_documents_list, encoding='utf-8'):
    ...
    luf = wsszeep.get_lookup_document_field('Статус', 'id', '11')

    param = wsszeep.get_param_accept_document_solution(
        comment_to_solution = 'SD376350',
        # emails_to_notify='',
        emails_to_notify='',
        reg_number=reg_num,
        # solution='Разослать',
